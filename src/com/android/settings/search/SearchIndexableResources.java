...
import com.android.settings.jtosp.jtospSettings;
...
public final class SearchIndexableResources {
    ...
    static {
        ...
        sResMap.put(jtospSettings.class.getName(),
                new SearchIndexableResource(
                        Ranking.getRankForClassName(jtospSettings.class.getName()),
                        NO_DATA_RES_ID,
                        jtospSettings.class.getName(),
                        R.drawable.ic_settings_jtosp));
